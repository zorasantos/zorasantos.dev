...
export default function Footer() {
  return (
  <footer className="sticky top-[100vh] flex flex-col justify-center gap-2 sm:flex-row sm:justify-between sm:gap-0 border-t-2 bottom-0 left-0 items-center w-full h-32 mt-10">
